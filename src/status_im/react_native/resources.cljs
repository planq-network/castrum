...
(def ui
  {:empty-chats-header (js/require "../resources/images/ui/empty-chats-header.png")
   :welcome            (js/require "../resources/images/ui/welcome.png")
   :welcome-dark       (js/require "../resources/images/ui/welcome-dark.png")
   :chat               (js/require "../resources/images/ui/chat.png")
   :chat-dark          (js/require "../resources/images/ui/chat-dark.png")
   :wallet             (js/require "../resources/images/ui/wallet.png")
   :browser            (js/require "../resources/images/ui/browser.png")
   :wallet-dark        (js/require "../resources/images/ui/wallet-dark.png")
   :browser-dark       (js/require "../resources/images/ui/browser-dark.png")
   :keys               (js/require "../resources/images/ui/keys.png")
   :keys-dark          (js/require "../resources/images/ui/keys-dark.png")
