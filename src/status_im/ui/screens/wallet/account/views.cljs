(ns status-im.ui.screens.wallet.account.views
  (:require
    ...
    [status-im.cosmos.account.governance.proposals.proposal-list-view :as governance-proposals]
    [status-im.cosmos.account.staking.validators-list :as staking-validators]
