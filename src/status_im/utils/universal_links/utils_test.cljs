...
(deftest universal-link-test
  ...
  (testing "http://join.planq.network/blah"
    (testing "it returns true"
      (is (links/universal-link? "http://join.planq.network/blah"))))
  (testing "https://join.planq.network/blah"
    (testing "it returns true"
      (is (links/universal-link? "https://join.planq.network/blah"))))
  (testing "unicode characters"
    (testing "it returns false"
      (is (not (links/universal-link? "https://join.planq.network/browse/www.аррӏе.com")))))
  ...
  (testing "http://join.planq.network/blah"
    (testing "it returns false"
      (is (not (links/deep-link? "http://join.planq.network/blah"))))))
