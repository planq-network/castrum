...
class AppiumContainer:
    ...
    def get_device_stats(self):
        ...
        # Find process uid
        uid_line = self.exec_run(['adb', 'shell', 'ps', '|', 'grep', 'network.planq.im']).output \
            .decode('utf-8')
        ...
        # Battery stats
        batterystats = self.exec_run(['adb', 'shell', 'dumpsys', 'batterystats', 'network.planq.im']).output \
        ...
        # Wi-Fi stats
        wifi_stats = self.exec_run(['adb', 'shell', 'dumpsys', 'batterystats', 'network.planq.im', '|', 'grep',
